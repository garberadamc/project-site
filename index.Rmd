...
- Lab 3: [Exploratory Factor Analysis (EFA) - R coding excercise: What's Missing?](https://garberadamc.github.io/project-site/Lab3-EFA-what-s-missing)
...
- Lab 5: [EFA Rotation, Introduction to Confirmatory Factor Analysis (CFA), and Path Diagrams](https://garberadamc.github.io/project-site/Lab5-rotation-efa)
