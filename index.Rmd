...
- Lab 10.1: [Weighted Least Squares Estimator](https://garberadamc.github.io/project-site/Lab10.1-WLS-efa-cfa-invariance){target="_blank"} [$\color{darkred}{\text{Lab10.1 - PDF version}}$](/Lab10.1-WLS-efa-cfa-invariance.pdf){target="_blank"}

- Lab 10.2: [Higher Order Factor Models](https://garberadamc.github.io/project-site/Lab10.2-Higher-Order-Factors){target="_blank"} 

- [$\color{darkred}{\text{Lab10.2 - PDF version}}$](/Lab10.2-Higher-Order-Factors.pdf)
