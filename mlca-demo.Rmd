...
#### This example of Multi-level Latent Class Analysis (MLCA) replicates the models described in Henry & Muthén (2010) using a different data example.

#### **Note:** All models are estimated in Mplus via the R package MplusAutomation.  
...
school_summary[1:10,] %>% 
  ...
  kable_styling(bootstrap_options = "striped", 
                full_width = F,
                position = "left") %>% 
                save_kable(here("figures", "grouped_descr_table.png"))
  #kable_as_image()
