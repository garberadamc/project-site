---
title: "Lab10.1 - Weighted Least Squares (WLS) "
...
- [$\color{blue}{\text{R-studio, R-Projects, Scripts: Go here}}$](https://rstudio-conf-2020.github.io/r-for-excel/rstudio.html)
- [$\color{blue}{\text{Rmarkdown basics tutorial: Go here (also chapters 3 and 4 from above link) here}}$](https://rmarkdown.rstudio.com/lesson-1.html)
...
knitr::include_graphics(here("figures", "model_fit_table_wls.png"))
```
