...
lab_data <- read_csv(here("Lab8_FA", "data", "lab7-8_els2002_data_subset.csv"))
...
knitr::include_graphics(here("Lab8_FA", "figures", "MIMIC2.png"))
```
...
mimic_output2 <- readModels(here("Lab8_FA", "mimic_mplus", "lab8_mimic_model2.out"))
...
knitr::include_graphics(here("Lab8_FA", "figures", "MIMIC4.png"))
```
...
mimic_output4 <- readModels(here("Lab8_FA", "mimic_mplus", "lab8_mimic_model4.out"))
...
knitr::include_graphics(here("Lab8_FA", "figures", "MIMIC5.png"))
```
...
mimic_output5 <- readModels(here("Lab8_FA", "mimic_mplus", "lab8_mimic_model5.out"))
```
...
```{r}
all_models <- readModels(here("Lab8_FA", "mimic_mplus"))
