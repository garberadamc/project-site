...
## IGNORE/SKIP (return here if you recieve an $\color{red}{\text{*error*}}$ when loading packages)
...
## [$\color{blue}{\text{LINK: RUN SHINY MVC}}$](http://www.biosoft.hacettepe.edu.tr/MVN/)
