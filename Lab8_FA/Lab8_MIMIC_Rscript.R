...
# i. We will keep close track of parameters and their status throughout lab
...
# c. choose location of project (too many nested folders = bad for `MplusObject` function)
...
# We are testing an alternative method for this procedure today (simply run the code below)
...
##### Lab exercise: How many parameters are there in this model (no cheating - i.e., jumping ahead)?
